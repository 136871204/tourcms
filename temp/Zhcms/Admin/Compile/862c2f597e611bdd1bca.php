...
<body>
<form action="<?php echo U(add);?>" method="post" id="add" class="zh-form">
    <div>
        <div class="content_left">
            <div class="title-header">新增订单</div>
            <table class="table1">
                <tr>
                ...
                <tr>
                    ...
                    <td>
						<div class="person_machine">
                            ...
                            <input type="text" data="1" class="gm_num num" id="adultnum" name="adultnum" readonly value="<?php if($lineinfo['dingnum']){?>$lineinfo.dingnum<?php  }else{ ?>0<?php }?>" />
                ...
                <tr id="haschild" style="display: none;">
                    ...
                    <td>
						<div class="person_machine">
							<input class="min" type="button" value="-">
                            <input type="text" data="2" class="gm_num num" id="childnum" name="childnum" readonly value="<?php if($lineinfo['childnum']){?>$lineinfo.childnum<?php  }else{ ?>0<?php }?>" />
							<input class="plus" type="button" value="+">
						</div>
                    </td>
                    <td>
                ...
                <tr id="hasold" style="display: none;">
                    ...
                    <td>
						<div class="person_machine">
							<input class="min" type="button" value="-">
                            <input type="text" data="3" class="gm_num num" id="oldnum" name="oldnum" readonly value="<?php if($lineinfo['oldnum']){?>$lineinfo.oldnum<?php  }else{ ?>0<?php }?>" />
							<input class="plus" type="button" value="+">
						</div>
                    </td>
                    <td>
											...
											<td>
                                                <select id="handleshop" name="handleshop">
                                                    <?php if(is_array($handleshop)):?><?php $index=0; ?><?php  foreach($handleshop as $shopK=>$shopD){ ?>
                                                        <option value="<?php echo $shopK;?>" <?php if($lineinfo['shopname'] == $shopD){?>selected='selected'<?php }?>><?php echo $shopD;?></option>
                                                    <?php $index++; ?><?php }?><?php endif;?>                                                    
                                                </select>
											</td>
										</tr>
...
<script type="text/javascript">
    ...
    function selectsuitid(){
        ...
        if( lineid == ''){
            ...
            select_exterior('line_suit','id','suitname','套餐',"lineid = "+lineid+" and suittype = 'b2c'",'single','suitid');
        }
    }
