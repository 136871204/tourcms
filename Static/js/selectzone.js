...
function SelectZone()
{
  ...
  this.filename  =  CONTROL+ "&is_ajax=1";
  var _self = this;
  ...
  {
    //alert(this.filename);
     /*var jsonStr=jQuery.toJSON(filters);
     alert(jsonStr);*/
    Ajax.call(this.filename+"&m=" + act, filters, this.loadOptionsResponse, "GET", "JSON");
  }
  ...
  this.addItem = function(all, act)
  {
    ...
    if (selOpt.length > 0)
    {
      ...
      //Ajax.call(this.filename+"&m=" + act, filters, this.loadOptionsResponse, "GET", "JSON");
      //alert(this.filename + "&m=="+act+"&add_ids=" +selOpt.toJSONString());
      Ajax.call(this.filename + "&m="+act+"&add_ids=" +selOpt.toJSONString(), args, this.addRemoveItemResponse, "GET", "JSON");
    }
  }
  ...
  this.dropItem = function(all, act)
  {
    ...
    if (arr.length > 0)
    {
      ...
      //Ajax.call(this.filename + "&m="+act+"&add_ids=" +selOpt.toJSONString(), args, this.addRemoveItemResponse, "GET", "JSON");
      Ajax.call(this.filename + "&m="+act+"&drop_ids=" + arr.toJSONString(), args, this.addRemoveItemResponse, 'GET', 'JSON');
    }
  }
