        ...
        <td>
            <table class="table1">
                ...
                <tr>
                    ...
                    <td>
                        <label><input type="radio" name="set[select_type]" value="multiple" <?php if($field['set']['select_type']=='multiple'){?>checked=""<?php }?>/> <?php echo $language['admin_field_exterior_item6_option1']; ?></label>
                        <label><input type="radio" name="set[select_type]" value="single" <?php if($field['set']['select_type']=='single'){?>checked=""<?php }?>/><?php echo $language['admin_field_exterior_item6_option2']; ?></label>
                    </td>
                </tr>
            </table>
        </td>
