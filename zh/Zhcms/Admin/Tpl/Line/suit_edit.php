                ...
                <div class="manage-nr">
                    ...
                    <div class="product-add-div">
                        <div class="add-class">
                            ...
                            <dl>
                                <dt>套餐类型{$info['suittype']}:  </dt>
                                <dd>
                                    <input type="radio" name="suittype" <if value="$info['suittype'] neq 'b2b' "> checked="checked" </if>  value="b2c"/><span style="font-size: 16px; font-weight: bold;">B2C</span>&nbsp;&nbsp;
                                    <input type="radio" name="suittype" <if value="$info['suittype'] eq 'b2b' "> checked="checked" </if> value="b2b"/><span style="font-size: 16px; font-weight: bold;">B2B</span>&nbsp;&nbsp;
                                </dd>
                            </dl>
                        ...
                        <div class="opn-btn" style="padding-left: 10px; " id="hidevalue">
                         <a class="save2" id="btn_view_more" style="<if value="$action=='add'">display:none</if>"   href="javascript:;" onclick="showMore()">查看修改报价</a>
                        </div>
                        <div class="w-set-tit bom-arrow" id="nav">
