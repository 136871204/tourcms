...
<head>
   ...
   $(function(){
    ...
    <script type="text/javascript" src="__STATIC__/tour/js/st_validate.js"></script>
    <script type="text/javascript" src="__STATIC__/tour/js/jquery.colorpicker.js"></script>
    ...
    <script type="text/javascript" src="__STATIC__/tour/js/jquery.upload.js"></script>    
...
<body>
    ...
    <div class="wrap">
        ...
        <form method="post" class="zh-form" name="product_fm" id="product_fm"   onsubmit="return false;" action="{|U:add}" enctype="multipart/form-data" >
            <div class="tab">
                <ul class="tab_menu">
                    ...
                    <div id="tab_basic">
                        <table class="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="linesn" data-required="true" value="{$info['linesn']}"  class="set-text-xh text_500 mt-2"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input  id="expire" name="expire" data-required="true" value="{$expirevalue}" class="w150" type="text"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="hotlinetel" data-required="true" value="{$info['hotlinetel']}"  class="set-text-xh text_400 mt-2"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>节假日名称：</th>
                                <td>
                                    <input type="text" name="holiday" value="{$info['holiday']}"  class="set-text-xh text_300 mt-2"/>
                                </td>
                            </tr>
                            <tr>
                                <th>线路特色：</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="save-value-div mt-2 ml-10 dest-sel">
                                        <foreach from="$info['kindlist_arr']" value="$v" >
                                        <span>
                                            <s onclick="$(this).parent('span').remove()"></s>
                                            {$v['kindname']}
                                            <input type="hidden" name="kindlist[]" value="{$v['id']}"/>
                                        </span>
                                        </foreach>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="save-value-div mt-2 ml-10 attr-sel wid_650">
                                        <foreach from="$info['attrlist_arr']" value="$v" >
                                        <span>
                                            <s onclick="$(this).parent('span').remove()"></s>
                                            {$v['attrname']}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="save-value-div mt-2 ml-10 icon-sel">
                                        <foreach from="$info['iconlist_arr']" value="$v" >
                                        <span>
                                            <s onclick="$(this).parent('span').remove()"></s>
                                            <img src="{$v['picurl']}"/>
                                            <input type="hidden" name="iconlist[]" value="{$v['id']}"/>
                                        </span>
                                        </foreach>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="{$info['lineday']}" data-regrex="number" data-required="true" data-msg="必须为数字" id="travel_days" class="w60" name="lineday"/>
                                    *天
                                    <input type="text" value="{$info['linenight']}" data-regrex="number" data-msg="必须为数字" class="w60" name="linenight"/>
                                    晚
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                        ...
                                        <input type="radio" name="baf"  <if value=" $info['baf']==0 " >checked="checked"</if> value="0"/>
                                        包含
                                        <input  type="radio" name="baf"  <if value=" $info['baf']==1 " >checked="checked"</if> value="1"/>
                                        不含
                                        <input  type="radio" name="baf"  <if value=" $info['baf']==2 " >checked="checked"</if> value="2"/>
                                        不显示
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="corporationnum"  data-required="true" value="{$info['corporationnum']}"  class="set-text-xh text_100 mt-2"/>
                                </td>
                            </tr>
                            <tr >
                                <th>提前天数：</th>
                                <td>
                                    建议提前
                                    <input type="text" name="linebefore" value="{$info['linebefore']}" data-regrex="number" data-msg="必须为数字" class="w60"/>
                                    天报名
                                </td>
                            </tr>
                            <tr>
                                <th>市场价：</th>
                                <td>
                                    <input type="text" value="{$info['storeprice']}" name="storeprice" class="w60"/>元
                                </td>
                            </tr>
                            <tr>
                                <th>推荐:</th>
                                <td>
                                    <foreach  from="$sysmagrecommend" value="$v"  key="$n" >
                                        <input name="magrecommend_pub[]" type="checkbox" class="checkbox" id="Magrecommend{$n}" <if value="strpos($info['magrecommend'],$v) !== false " >checked="checked" </if> value="{$v}" />&nbsp;
                                        <label for="Magrecommend{$n}">{$v}</label>
                                    </foreach>
                                    <foreach  from="$usermagrecommend" value="$user"   key="$n" >
                                        <if value=" !in_array($user,$sysmagrecommend) && !empty($user) ">
                                        <input name="magrecommend_pub[]" type="checkbox" class="checkbox" id="Magrecommend_user_{$n}" checked="checked" value="{$user}" />&nbsp;
                                        <label for="Magrecommend_user_{$n}">{$user}</label>
                                        </if>
                                    </foreach>
                                    <span id="addmr"></span>
                                    <img style="line-height: 30px;vertical-align: middle;cursor: pointer" onclick="addMagrecommend()" src="__STATIC__/tour/images/tianjia.png" />
                                </td>
                            </tr>
                            <tr>
                                <th>往返交通:</th>
                                <td>
                                    <foreach  from="$sysjiaotong" value="$v">
                                        <input name="transport_pub[]" type="checkbox" class="checkbox" id="Transport{$n}" <if value="strpos($info['transport'],$v) !== false " >checked="checked" </if> value="{$v}" />&nbsp;
                                        <label for="Transport{$n}">{$v}</label>
                                    </foreach>
                                    <foreach  from="$usertransport" value="$user">
                                        <if value=" !in_array($user,$sysjiaotong) && !empty($user) ">
                                        <input name="transport_pub[]" type="checkbox" class="checkbox" id="Transport_user_{$n}" checked="checked" value="{$user}" />&nbsp;
                                        <label for="Transport_user_{$n}">{$user}</label>
                                        </if>
                                    </foreach>
                                    <span id="addjt"></span>
                                    <img style="line-height: 30px;vertical-align: middle;cursor: pointer" onclick="addJiaoTong()" src="__STATIC__/tour/images/tianjia.png" />
                                </td>
                            </tr>
                            <?php
                            if($roleid==18){
                             ...
                             ?>
                                ...
                                <td>
                                    <span >推荐次数</span>
                                    <input type="text" name="yesjian" value="{$info['yesjian']}" data-regrex="number" data-msg="*必须为数字" class="w60"/>
                                    <span  style="display: none;" >满意度</span>
                                    <input  style="display: none;" type="text" name="satisfyscore" value="{$info['satisfyscore']}" data-regrex="number" data-msg="*必须为数字" class="w60"/>
                                    <span >销量</span>
                                    <input type="text" name="bookcount" value="{$info['bookcount']}" data-regrex="number" data-msg="*必须为数字" class="w60"/>
                                </td>
                            </tr>
                            <tr>
                                <th>前台公开：</th>
                                <td>
                                        ...
                                        <input type="radio" name="ishidden"  <if value=" $info['ishidden']==0 " >checked="checked"</if> value="0"/>
                                        公开
                                        <input  type="radio" name="ishidden"  <if value=" $info['ishidden']==1 " >checked="checked"</if> value="1"/>
                                        非公开
                                </td>
                            </tr>
                            ...
                            <tr  style="display: none;">
                                <th>儿童标准:</th>
                                <td>
                                    <input type="text" class="w700" name="childrule" value="{$info['childrule']}"/>
                                </td>
                            </tr>
                            <tr  style="display: none;">
                                <th>婴儿标准:</th>
                                <td>
                                    <input type="text" class="w700" name="babyrule" value="{$info['babyrule']}"/>
                                </td>
                            </tr>
                            <tr  style="display: none;">
                                <th>显示模版:</th>
                                <td>
                                    <input style="width:300px;" id="template" name="template" value="{$info['template']}" onfocus="select_template('template');" type="text"/><span id="zh_template"></span>
                            ...
                            <tr  style="display: none;">
                                <th>标题颜色：</th>
                                <td>
                                    <input type="text" name="color" value="{$info['color']}" class="set-text-xh text_100 mt-2 title-color"/>
                                </td>
                            </tr>
                        </table>
                    </div>
                                       ...
                                       $imageup.='<fieldset class="img_list">';
                                            ...
                                            if (!empty($v['timg'])) {
                                                ...
                                                foreach ($pic_arr as $pick => $picv) {
                                                    ...
                                                    $h .= "<li><div class='img'><img src='__ROOT__/" . $imginfo_arr[0] . "' style='width:135px;height:135px;'/>";
                                					$h .= "<a href='javascript:;' onclick='remove_upload(this,\"$id\")'>X</a>";
                                					$h .= "</div>";
                                					$h .= "<input type='hidden' name='" . $tname. "[path][]'  value='" . $imginfo_arr[0] . "' src='__ROOT__" . '/' . $imginfo_arr[0] . "' class='w400 images'/> ";
                        ...
                        elseif($col['columnname']=='biaozhun'){
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <div class="temp-chg">
                                            ...
                                            <input type="hidden" name="biaozhun_isstyle" id="biaozhun_isstyle" value="{$info['biaozhun_isstyle']}"/>
                                        </div>
                                    </dd>
                                </dl>
                            </div>
                            ...
                            <div class="content-biaozhun-detail" style="<?php  if($info['biaozhun_isstyle']==1) echo 'display:none';?>">
                                ...
                                <table class="table1" id="biaozhuninfo">
                                    ...
                                    <if value="empty($info.biaozhun_detail)">
                                    ...
                                    <else/>
                                    <foreach from="$info.biaozhun_detail" value="$bz" key="$key">
                                    <tr class="biaozhuninfo">
                                        <th class="w80"><input name="biaozhuninfo{$key}" value="<?php echo $bz["biaozhuninfo".$key];?>" /></th>
                                        <th><input name="biaozhuncompany{$key}" value="<?php echo $bz["biaozhuncompany".$key];?>" /></th>
                                        <th><input name="biaozhunnum{$key}" value="<?php echo $bz["biaozhunnum".$key];?>" /></th>
                                        <th><input name="biaozhunstartairport{$key}" value="<?php echo $bz["biaozhunstartairport".$key];?>" /></th>
                                        <th><input name="biaozhunstarttime{$key}" value="<?php echo $bz["biaozhunstarttime".$key];?>" /></th>
                                        <th><input name="biaozhunendairport{$key}" value="<?php echo $bz["biaozhunendairport".$key];?>" /></th>
                                        <th><input name="biaozhunendtime{$key}" value="<?php echo $bz["biaozhunendtime".$key];?>" /></th>
                                    </tr>
                                    </foreach>
                                    </if>
                                </table>
                                <input type="hidden" name="biaozhuncount" id="biaozhuncount" value="{$info.biaozhun_detail|count}" />
                    ...
                    <div id="tab_attachment">
                        <table class="table1">
                            <tr>
                                ...
                                <td>
                                    <input id="linepic" name="linepic" value="{$info['linepic']}" src="__ROOT__/{$info['linepic']}" class="w300 images" onmouseover="view_image(this)" type="text"/>
                                    ...
                                    <fieldset class="img_list">
                                        ...
                                        if (!empty($info['piclist'])) {
                                            ...
                                            foreach ($pic_arr as $k => $v) {
                            					...
                            					$h .= "<a href='javascript:;' onclick='remove_upload(this,\"$id\")'>X</a>";
                            					$h .= "</div>";
                            					$h .= "<input type='hidden' name='" . "piclist" . "[path][]'  value='" . $imginfo_arr[0] . "' src='__ROOT__" . '/' . $imginfo_arr[0] . "' class='w400 images'/> ";
                    ...
                    <div id="tab_seo">
                        <table class="table1">
                            <tr>
                                <th>优化标题：</th>
                                <td>
                                    <input type="text" name="seotitle" value="{$info['seotitle']}" class="w700"/>
                                </td>
                            </tr>
                            <!--
                            <tr>
                                <th>Tag词：</th>
                                <td>
                                    <input type="text" name="tagword" class="w700" value="{$info['tagword']}">
                                </td>
                            </tr>
                            -->
                            <tr>
                                <th>关键词：</th>
                                <td>
                                    <input type="text" name="keyword" value="{$info['keyword']}" class="w700"/>
                                </td>
                            </tr>
                            <tr>
                                <th>页面描述：</th>
                            ...
                            <tr>
                                <th>热门线路：</th>
                                <td>
                                    <input id="hotlines" name="hotlines" style="width:300px" class="" value="{$info['hotlines']}" type="text"/><span id="zh_hotlines"></span>
            ...
            <div class="position-bottom">
                ...
                <if value="isset($_GET['lineid'])">
                <a target="_blank" class="btn1" href="/lines/detail/{$zh.get.lineid}.html" style="font-size: 16px;font-weight:bold;" >预览</a>
                </if>
            </div>
        </form>
    </div>
        ...
        function beforeJieshao(){
            ...
            if(days<=0 || isNaN(days) )
            {
                ...
                jiaotong+="<span id=\"addjt_{day}\"></span>"+
                          "<img class='addimg' data-contain='addjt_{day}' data-day='{day}' style=\"line-height: 30px;vertical-align: middle;cursor: pointer\"  src=\"__STATIC__/tour/images/tianjia.png\">";
