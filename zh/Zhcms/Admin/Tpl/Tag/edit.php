...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="javascript:;" class="action">tag修正</a></li>
        </ul>
    </div>
    <div class="title-header">tag修正</div>
    <form action="{|U:'edit'}" method="post" onsubmit="return zh_submit(this,'{|U:index}')" class="zh-form">
