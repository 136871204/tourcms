...
$(function () {
    ...
    $('#add_upload_water').attr("checked",false);
})
//----------获得站内图片与未使用图片-----------------
    ...
    $("#pic_selected").click(function () {
        switch (type) {
            ...
            case "images":
                ...
                img_div.append(_ul);
                //父窗口中记录数量的span标签
                var _num_span = $(parent.document).find('#zh_up_' + id);
                //更改数量
            ...
            case "files":
                ...
                $(_img).each(function (i) {
                    ...
                    _ul += "<img src='" + ZHPHPEXTEND + "/Org/Uploadify/default.png' style='width:50px;height:50px;'/>";
...
//uploadify上传完图片后自动选中
function zh_upload(file, data, response){
