...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="javascript:;" class="action">添加供货商</a></li>
        </ul>
    </div>
    <div class="title-header">供货商情报</div>
    <form action="{|U:'add'}" method="post" class="zh-form"  onsubmit="return zh_submit(this,'{|U:index}')">
        ...
        <table class="table1">
            <tr>
                ...
                <td>
                    <input type="text" name="suppliers_name" class="w300" maxlength="60" value="" />
                </td>
            </tr>
            <tr>
                <th class="w100">供货商描述：</th>
                <td>
                    <textarea  name="suppliers_desc" cols="60" rows="4"  ></textarea>
