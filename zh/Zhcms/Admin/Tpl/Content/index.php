...
<head>
    ...
    <title>{$zh.language.admin_content_index_page_title}</title>
    <zhjs/>
...
<div class="wrap">
    <div id="category_tree">
        <div id="tree_title">
            <span></span>
            <a href="javascript:;" onclick="get_category_tree();">{$zh.language.admin_content_index_page_category_link}</a>
        </div>
