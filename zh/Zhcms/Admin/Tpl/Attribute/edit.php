...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="javascript:;" class="action">修改属性</a></li>
        </ul>
    </div>
    <div class="title-header">属性情报</div>
    <form action="{|U:edit}" method="post" name="theForm" class="zh-form" onsubmit="return zh_submit(this,'{|U:index,array('goods_type'=>$_GET['goods_type'])}');">
