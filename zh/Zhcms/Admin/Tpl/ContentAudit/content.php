...
<body>
<div class="wrap">
    <form id="search" action="{|U:'content'}" class="zh-form" method="post">
        <div class="search">
            模型：
    ...
    <table class="table2 zh-form">
        ...
        <list from="$data" name="d">
            <tr>
                ...
                <td>
                    <a href="{|U:'Index/Index/Content',array('mid'=>$mid,'cid'=>$d['cid'],'aid'=>$d['aid'])}" target="_blank">
                        访问</a>
                </td>
            </tr>
        </list>
...
<div class="position-bottom">
    ...
    <input type="button" class="zh-cancel" onclick="del({$mid})" value="批量删除"/>
    <input type="button" class="zh-cancel" onclick="audit({$mid},1)" value="审核"/>
</div>
</body>
</html>