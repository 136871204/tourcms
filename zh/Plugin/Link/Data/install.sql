...
DROP TABLE IF EXISTS `zh_link_config`;
CREATE TABLE `zh_link_config` (
...
INSERT INTO `zh_link_config` VALUES ('1', 'metaphase', 'http://localhost/zhcms', 'zh/Plugin/Link/Data/logo.png', 'hong@metaphase.co.jp', '1、请先在贵站做好后盾网的友情链接\r\n2、将右侧‘文字链接’或‘图片链接’代码复制到贵站\r\n3、凡开通我站友情链接且内容健康的网站，经管理员审核后，将显示在此友情链接页面\r\n4、首页友情连接，要求pr>=2、alexa < 10000；其他页面连接根据具体页面而定（请具体咨询）\r\n5、贵网站要在百度google都有记录收录，且网站访问速度不能太慢', '1', '1', '2300071698');

DROP TABLE IF EXISTS `zh_link_type`;
CREATE TABLE `zh_link_type` (
...
INSERT INTO `zh_link_type` VALUES ('1', '友情链接', '1'), ('2', '合作伙伴', '1');
