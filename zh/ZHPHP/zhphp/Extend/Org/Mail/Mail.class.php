 ...
 * @author      周鸿 <136871204@qq.com>
 */
require ZHPHP_EXTEND_PATH . 'Org/Mail/Class.phpmailer.php';
class Mail{
	...
	static private function config() {
		...
		self::$mail -> PluginDir = ZHPHP_EXTEND_PATH . 'Org/Mail/';
		self::$mail -> SetLanguage("en", ZHPHP_EXTEND_PATH . '/Mail/Language/');
		self::$mail -> IsSMTP();
		//是否为SMTP 必须设置
