...
final class Data {
    ...
    static function menu_linkage_level($linkageid,$keyid,$infos,$result=array()) {
    	if(array_key_exists($linkageid,$infos)) {
    		$result[]=$infos[$linkageid]['title'];
    		return self::menu_linkage_level($infos[$linkageid]['pid'],$keyid,$infos,$result);
    	}
    	krsort($result);
