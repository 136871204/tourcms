...
return array(
    ...
    /********************************图像水印处理********************************/
    'WATER_ON'                      => TRUE,           //开关
    'WATER_FONT'                    => ZHPHP_PATH . 'Data/Font/font.ttf',   //水印字体
    'WATER_IMG'                     => ZHPHP_PATH . 'Data/Image/water.png', //水印图像
    ...
    'THUMB_PATH'                    => '',          //缩略图路径
    /********************************验证码********************************/
    'CODE_FONT'                     => ZHPHP_PATH . 'Data/Font/font.ttf',       //字体
    ...
    'PAGE_STYLE'                    => 2,           //页码风格
    'PAGE_DESC'                     => array('pre' => '前へ', 'next' => '次へ',//分页文字设置
                                            'first' => 'トップ', 'end' => '尾页', 'unit' => '件'),
    /********************************模板参数********************************/
    'TPL_PATH'                      => '',          //模板目录
    'TPL_STYLE'                     => '',          //风格
    ...
    'EMAIL_FROMNAME'                => 'ZHCMS',      //发送人发件箱显示的用户名
    /********************************COOKIE********************************/
    'COOKIE_EXPIRE'                 => 0,           // Coodie有效期
    'COOKIE_DOMAIN'                 => '',          // Cookie有效域名
    'COOKIE_PATH'                   => '/',         // Cookie路径
